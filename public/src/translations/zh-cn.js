...
window.Translations['zh-cn'] = {
  ...
  NEW_PWD_TIP_2: '请确保您已安全保存主密码，如果您失去您的主密码，您的帐户将永远无法再打开，您将失去您所有的 SERC',
  CONFIRM: '确认',
  CANCEL: '返回',
  ...
  PAY_TIP: '请确保您正在发送 SERC 给正确的地址，本操作无法撤消',
  ...
  INPUT_AGAIN: '再次输入',
  PASSWORD: '密码',
  SUBMIT_SECOND_PASSWORD_TIP: '请确定您已经安全保存了二级密码，一旦丢失，您在Asch系统中的财产将无法找回，设置二级密码需要5SERC手续费',
  SUBMIT: '提交',
  ALREADY_SET: '已设置',
  NOT_SET: '未设置',
  ...
  DAPP_COIN_FEE: '本次充值手续费: 0.1 SERC',
