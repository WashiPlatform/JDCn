...
private.attachApi = function () {
  ...
  library.network.app.use('/api/info', router)
...
// Public methods
Info.prototype.sandboxApi = function (call, args, cb) {
  sandboxHelper.callMethod(shared, call, args, cb)
}

// Events
Info.prototype.onBind = function (scope) {
  modules = scope
}
