...
module.exports.connect = function (connectString, cb) {
  ...
  var sql = [
    ...
    "CREATE TABLE IF NOT EXISTS price (name INTEGER NOT NULL, price VARCHAR(20) NOT NULL, issuePrice VARCHAR(20) NOT NULL)",
